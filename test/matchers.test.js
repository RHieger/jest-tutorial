...
describe("toHaveLength (array elements)", () => {
...
describe("not.toHaveLength (array elements)", () => {
...
describe("toBeGreaterThan", () => {
  test("seconds per day are greater than 1,440", () => {
...
describe("not.toBeGreaterThan", () => {
  test("seconds per day are not greater than 86,401", () => {
...
describe("toBeGreaterThanOrEqual", () => {
  test("seconds per day are greater than or equal to 86,400", () => {
...
describe("not.toBeGreaterThanOrEqual", () => {
  test("seconds per day are not greater than or equal to 86,401", () => {
...
// Matcher: not.toContainEqual(property)

describe("not.toContainEqual(property)", () => {
  test("my name is not Robert", () => {
    const myPerson = { name: "Jo" };
